      ...
      return `
        ...
        <div class="grid-2">
          <div class="panel">
            ...
            columns: ["业务时间", "业务单号", "业务类型", "站点ID", "站点名称", "发起主体身份", "发起主体ID", "发起主体名称", "资金方向", "交易金额", "凭证号", "核销状态", "后端落账状态"],
      ...
      return `
        ...
        <div class="panel">
          ...
          ${renderTable({
            ...
            rows,
              columns: ["业务时间","业务单号","业务类型","站点ID","站点名称","发起主体身份","发起主体ID","发起主体名称","资金方向","交易金额","手续费","实际入账/出款","影响余额","影响控制台账","关联账本","凭证号","借贷状态","核销状态","后端落账状态","财务处理建议"],
            actions: row => renderBusinessFundingActions(row)
          })}
        </div>
      `;
